...
.directive('ngDatepicker', ['$document', function($document) {
	...
	return {
		...
		link: function (scope, element, attrs, ngModel) {
			...
			var classList = ['ng-datepicker', 'ng-datepicker-input form-control ng-pristine ng-untouched ng-valid ng-isolate-scope'];
		...
		template: 
		'<div><input type="text" ng-focus="showCalendar()" ng-value="viewValue" class="ng-datepicker-input form-control ng-pristine ng-untouched ng-valid ng-isolate-scope" placeholder="{{ placeholder }}"></div>' +
